...
You can subclass `SpaceMiningEnv` to modify the reward function, physics parameters, or add new features like multi-agent support. Ensure to update the observation and action spaces accordingly if changes are made.
